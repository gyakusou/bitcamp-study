...
public class Servlet01 extends GenericServlet {
  ...
  public void service(ServletRequest req, ServletResponse res)
    ...
    //
    // 테스트
    // - http://localhost:9999/bitcamp-java-web/ex04/s1.html 실행
    //
...
// => 서블릿 클래스의 실제 위치:
// 톰캣배치폴더/wtpwebapps/bitcamp-java-web/WEB-INF/classes/com/eomcs/web/ex04/.class
// => 요청:
...
// => 정적 파일의 실제 위치:
// 톰캣배치폴더/wtpwebapps/bitcamp-java-web/ex04/test01.html
// => 요청:
// http://localhost:9999/bitcamp-java-web/ex04/test01.html

// 3. /WEB-INF/ 폴더에 있는 정적 파일을 받고 싶을 때
// => 정적 파일의 실제 위치:
// 톰캣배치폴더/wtpwebapps/bitcamp-java-web/WEB-INF/ex04/test01.html
// => 요청:
