...
public class Servlet03 extends HttpServlet {
  ...
  //
  // 결론?
  // => 개발자는 서블릿 객체가 생성될 때 뭔가 작업을 수행하고 싶다면,
  // 이 메서드를 직접 오버라이딩을 하지말고,
  ...
  public void init() throws ServletException {
    ...
    // DB에 연결하려면 JDBC Driver 이름과 JDBC URL, 사용자 아이디, 암호를 알아야 한다.
    //
    ...
    // String jdbcDriver = "org.mariadb.jdbc.Dirver";
    ...
    // @WebInitParam(name = "jdbc.driver", value = "org.mariadb.jdbc.Driver"
    // => 애노테이션에 설정된 값을 꺼내기 위해서는 Servlet 객체가 필요하다.
    ...
    String jdbcName = this.getInitParameter("jdbc.username");
    String jdbcPassword = this.getInitParameter("jdbc.password");
