...
public class Exam04_2 {
    public static void main(String[] args) {
        ...
        // x000 0000 0000 0000 0000 0000 0011 0100|1
        // 0000 0000 0000 0000 0000 0000 0011 0100 = 52
        
        
        System.out.println(i >> 2); // 00011010|0 => 26
        // xx00 0000 0000 0000 0000 0000 0001 1010|01
        // 0000 0000 0000 0000 0000 0000 0001 1010 = 26
        
        
        System.out.println(i >> 3); // 00001101|0 => 13
        // xxx0 0000 0000 0000 0000 0000 0000 1101|001
        // 0000 0000 0000 0000 0000 0000 0000 1101 = 13
        
        
        System.out.println(i >> 4); // 00000110|1 => 6
        // xxxx 0000 0000 0000 0000 0000 0000 0110|1001
        // 0000 0000 0000 0000 0000 0000 0000 0110 = 6
        
        
        // 오른쪽으로 이동
        // 왼쪽 쪽 빈자리를 원래 숫자와 같은 부호로 값으로 채운다.
        //                  양수면 0, 음수면 1을 채운다.
        // 오른쪽 경계를 넘어간 비트 : 짜른다.
...
// 실무에서는 나눗셈 연산이 비용이 많이 들기 때문에 (시간과, cpu 사용량) 
// 소수 점 이하 까지 정확하게 계산할게 아니라면 오른쪽 비트 이동 연산자를 사용하여 주로 처리한다.
