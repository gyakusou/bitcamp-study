...
public class Exam0230 {
  public static void main(String[] args) {
    ...
    // 설명 :
    // => 정수 리터럴을 이용하여 auto-boxing으로 객체를 생성할 경우 상수 constants pool에 생성된다.
    // => 같은 값을 가지는 정수 Integer 객체가 여러개 존재해야 할 필요가 없다.
    ...
    // 다음과 같이 auto-boxing 으로 생성된 객체와 valueOf()가 리턴한 객체를 비교해보자.
