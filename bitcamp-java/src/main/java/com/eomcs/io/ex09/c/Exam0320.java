...
public class Exam0320 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // - Exam0320 에서 Member 객체를 읽는다.
    // - 결과
    //   java.io.invalidClassException 실행 오류가 발생한다.
    // - 이유
    //   deserialize 할 때, 
    ...
    // 같은지 검사하는 방법
    // (serialize 할 때 사용한 Member 클래스와 deserialize 할 때 사용할 Member 클래스가 동일한 클래스인지 검사하는 방법)
    // - 클래스에 내장된 스태틱 변수인 serialVersionUID 변수의 값을 비교한다. 
    //   
    ...
    // - 컴파일러는 이 클래스의 serailVersionUID 변수에 대해 임의의 값을 부여한다.
    // - Exam0310에서 Member 객체를 출력할 때 이 변수의 값도 출력하였다.
    // - Member 클래스를 변경한다.
    // - 컴파일러 또한 클래스의 serialVersionUID 변수의 값을 변경한다.
    ...
    // - JVM은 저장 할 때 형식과 읽을 때 메모리 형식이 다르다고 판단하여 
    //   오류를 띄운다.
  }
