...
// 그래서 같은 메모리라도 Stateful 방식 보다는 더 많은 클라이언트의 요청을 처리할 수 있다.
//
// => 대표적인 예:
...
//                |--------x-------> 끊기
//
// - 서버에 요청 할 때 마다 연결하고 응답을 받으면 즉시 연결을 끊는다.
// - 따라서 비영속적인 단일 작업을 처리할 때 적합한 통신방식이다.
