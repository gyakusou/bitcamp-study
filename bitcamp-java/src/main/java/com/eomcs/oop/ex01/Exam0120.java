...
public class Exam0120 {
  public static void main(String[] args) {
    ...
    class Score { // 클래스명 클래스문법의 2가지 사용법 1. 사용자 정의데이터 타입 적용, 2. 관련 메소드 묶는 용도
      String name;
      int kor;
      int eng;
      int math;
    ...
    // => int와 같은 primitive data type 인 경우
    //    위와 같이 그냥 변수를 선언하면 되지만, 클래스로 문법으로 설계한 메모리는 이런 방식으로 만들 수 없다.
