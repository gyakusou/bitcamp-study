...
public class Exam0210 {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(s1.compareTo("Helli")); // compareTo 인스턴스 메서드
        System.out.println(s1.compareTo("Hello"));
        System.out.println(s1.compareTo("Hellu"));
        
        System.out.println(s1.contains("ll")); // contains 인스턴스 메서드 / s1은 ll을 포함하고있나?
        System.out.println(s1.contains("ee"));
        
        // 두 문자열을 연결하여 새 문자열을 만들자!
        String s2 = s1.concat(", world!"); // concat 인스턴스 메서드
        ...
        System.out.println(s1.equals("Hello")); // equals 인스턴스 메서드
        ...
        // => 형식을 갖춘 문자열을 만들기
        String s4 = String.format("%s님 반갑습니다", "홍길동"); // format 클래스메서드
        System.out.println(s4);
        
        // => 구분자와 문자열들을 파라미터로 받아서 새 문자열을 만든다.
        String s5 = String.join(":", "홍길동", "임꺽정", "유관순"); // join 클래스메서드 /첫번째 아규먼트 : /두번째 아규먼트 홍길동 /세번째 아규먼트 임꺽정 /네번째 아규먼트 유관순
