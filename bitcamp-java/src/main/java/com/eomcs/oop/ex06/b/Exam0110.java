...
public class Exam0110 {
    ...
    static class Calculator {
      ...
      // 다음과 같이 같은 일을 수행 (두 수를 더하는일) 하는 메서드라도
      // 이름을 다르게 해야 한다.
    ...
    public static void main(String[] args) {
      ...
      // 두개의 정수를 더할 때는 plusi()를 호출해야 한다.
      int r1 = Calculator.plusi(100, 200);
      
      // 한개의 정수를 두번 더할 때는 plusi2()를 호출해야 한다.
      int r2 = Calculator.plusi2(100);
      
      // 두개의 부동 소수점을 더할 때는 pulsf()를 호출해야 한다.
      float r3 = Calculator.plusf(35.7f, 22.2f);
      
      System.out.printf("%d, %d, %.1f\n", r1, r2, r3);
      
      // 같은 더하기 일을 하더라도 더하는 값의 타입에 따라 
      // 메서드 이름이 다르다면 호출할 때, 메서드를 사용하기가 번거롭다.
