...
public class E extends Object {
  ...
  E(String s) {
    // 수퍼 클래스(super)의 생성자나 자신의 생성자(this)나 모두 첫 문장으로 와야 하기 때문에
    // 다음과 같이 나란히 호출 할 수 없다. 둘 중 하나만!
    // super();
    // this();
  }
...
class E3 extends E2 {
  ...
  E3() {
    // 수퍼 클래스의 기본 생성자가 없을 때,
    // 개발자가 직업 어떤 수퍼 클래스의 생성자를 호출 할 지 지정해야한다.
    super(100); //E2(int)의 생성자를 호출한다.
  }
}
...
class TestE {
  public static void main(String[] args) {
    ...
    // 결국 실행은 상위 클래스의 생성자 부터 실행하면서 내려온다.
