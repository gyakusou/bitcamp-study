...
public class ServerApp {
  ...
  Map<String, Object> context = new HashMap<>(); // 옵저버 사이에 데이터 교환하기 위한 저장소
  ...
  /*
   try ( 
   // 서버쪽 연결 준비 
   // => 클라이언트의 연결을 9999번 포트에서 기다린다. ServerSocket severSocket = new
   ServerSocket(9999)) {
   ...
   Socket socket = everSocket.accept(); System.out.println("클라이언트와 연결되었음");
   ...
   System.out.println("서버 준비 중 오류 발생"); return; }}
   */
