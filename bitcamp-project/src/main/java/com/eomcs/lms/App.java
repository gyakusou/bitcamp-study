...
public class App {
  ...
  private static void loadLessonData() {
    ...
    File file = new File("./lesson.data"); // v29

    try (DataInputStream in = new DataInputStream( // v29
  ...
  private static void saveLessonData() {
    ...
    try (DataOutputStream out = new DataOutputStream( // v29
  ...
  private static void saveBoardData() {
    ...
    try (DataOutputStream out = new DataOutputStream( // v29
      ...
      for (Board board : boardList) {
        ...
        out.writeUTF(board.getWriter() == null ? "" : board.getWriter()); // null이면 출력되지 않는다.
        // 조건연산자 앞의 연산식이 트루면 앞의것 펄스면 뒤에것
      }
