...
public class BoardHandler {
  ...
  public static void addBoard(BoardHandler boardHandler) { // () 주소넣기 설계도에 따라 만든 board handler의 인스턴스 주소
  ...
  public static void listBoard(BoardHandler boardHandler) { // () 주소넣기 설계도에 따라 만든 board handler의 인스턴스 주소
