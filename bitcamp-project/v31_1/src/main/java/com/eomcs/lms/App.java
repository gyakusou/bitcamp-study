...
public class App { // 31
  ...
  // - set은 등록 순서를 따지지 않는다.
  Set<ApplicationContextListener> listeners = new HashSet<>(); // 31 2

  // 옵저버를 등록하는 메서드이다.
  public void addApplicationcontextListener(ApplicationContextListener listener) { // 31 2
    listeners.add(listener);
  }

  public void removeaddApplicationcontextListener(ApplicationContextListener listener) { // 31 2
    listeners.remove(listener);
  }

  // 애플리케이션이 시작될 때 등록된 리스너에게 알린다.
  private void notifyApplicationInitialized() { // 31 2
  ...
  private void notifyApplicationDestroyed() { // 31 2
    for (ApplicationContextListener listener : listeners) {
  ...
  public void service() { // 31
    ...
    notifyApplicationInitialized(); // 31 2
    ...
    notifyApplicationDestroyed(); // 31 2 //////////////////////////////////////////////////////////
