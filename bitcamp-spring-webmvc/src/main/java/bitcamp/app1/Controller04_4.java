...
// http://localhost:9999/bitcamp-spring-webmvc/app1/c04_4/h1
// app1 은 dispatcherServlet 으로 보내야 한다.
@Controller
...
public class Controller04_4 {
  ...
  public void handler1( //
      ...
      // 값이 안넘어오면 에러뜬다. 에러 안띄울려면 디폴트값을 설정하는 것이 좋다.
  ...
  //
  @InitBinder // requestHandler 가 호출되기 직전에 호출된다. requestHandler가 필요한 것들을 미리 받는다.
  public void initBinder(WebDataBinder binder) { // 반드시 파라미터로 받아야 한다.
  ...
  class DatePropertyEditor extends PropertyEditorSupport {
    ...
    public void setAsText(String text) throws IllegalArgumentException {
      ...
      try {
        ...
        setValue(java.sql.Date.valueOf(text)); // text 값이 yyyy-MM-dd 이 형식일 때만 가능하다.
