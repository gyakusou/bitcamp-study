...
public class Controller01_1 {
  ...
  @GetMapping("h1")
  // @ResponseBody // 뷰 이름을 리턴 할 때는 이 애노테이션을 붙이면 안된다. 리턴값은 경로를 통해 jsp값이 나온다.
  ...
  public String handler1(Model model) {
    ...
    //
    // InternalResouceViewResolver로 교체한 다음의 JSP URL은?
  ...
  public void handler2(Model model) {
    ...
    //
    // InternalResouceViewResolver로 교체한 다음은?
    // => 리턴 값이 없으면 요청 URL(/c01_1/h2)을 리턴값으로 사용한다.
