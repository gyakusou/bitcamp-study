...
// h1은 model에 name2와 age2와 tel2를 저장하는데, sessionAttributes에서 name2와, age2를 선언하면, 이 두 값은 세션에도 저장시킨다.
// tel의 경우는 선언하지 않았기 때문에 session에 저장되지 않았다.
...
public class Controller03_2 {
  ...
  public String handler2(HttpSession session) {
    return String.format("name2=%s, age2=%s, tel2=%s", session.getAttribute("name2"),
  ...
  public String handler4(
      ...
      @ModelAttribute("name") String name, @ModelAttribute("age") String age,
